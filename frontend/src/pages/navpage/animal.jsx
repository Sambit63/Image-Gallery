...
const Animal=()=>{
  ...
  <img
    src="https://cdn.wallpapersafari.com/31/74/KlYDph.jpg"
    alt="Error"
  ...
  <div style={{ 
    ...
    <div>
      <h1>Animals</h1>
      <p style={{fontSize:"18px",fontStyle:"italic"}}>Immerse yourself in the captivating world of animals through our animal category in the image gallery. Explore a diverse collection of photographs showcasing the beauty, diversity, and wonder of the animal kingdom.</p>
