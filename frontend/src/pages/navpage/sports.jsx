...
const Sport=()=>{
    ...
    const getData= async()=>{
        await fetch("http://localhost:8080/sports",{
            method:"GET",
        })
        .then((res)=> res.json())
        .then((data)=>{
  ...
  <img
    src="https://cdn.wallpapersafari.com/60/48/dKrfUL.jpg"
    alt="Error"
  ...
  <div style={{ 
    ...
    <div>
      <h1>Sports</h1>
      <p style={{fontSize:"18px",fontStyle:"italic"}}>Experience the thrill of athleticism in our image gallery's Sports category. Dive into a dynamic collection of sports action, intense competitions, and inspiring moments. From team sports to individual feats of skill, celebrate the passion, dedication, and triumphs of athletes across various sports disciplines.</p>
