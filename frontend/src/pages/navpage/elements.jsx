...
const Element=()=>{
    ...
    const getData= async()=>{
        await fetch("http://localhost:8080/elements",{
            method:"GET",
        })
        .then((res)=> res.json())
        .then((data)=>{
  ...
  <img
    src="https://wallup.net/wp-content/uploads/2019/09/427782-dna-3-d-structure-molecule-pattern-abstraction-genetic-psychedelic-748x421.jpg"
    alt="Error"
  ...
  <div style={{ 
    ...
    <div>
      <h1>Element</h1>
      <p style={{fontSize:"18px",fontStyle:"italic"}}>Dive into the fascinating world of chemistry elements in our image gallery's Elements category. Explore the building blocks of matter and discover the beauty and diversity of the elements that make up our universe.</p>
